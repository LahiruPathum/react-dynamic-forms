...
const DynamicFormGenerator = ({}: Props) => {
  ...
  const [form, setForm] = React.useState<FormItemTreeNode[]>([
    new FormItemTreeNode('Container', { type: '', id: '' }),
  ]);
  const RootContainer = new FormItemTreeNode('Container', {
    type: 'conatiner-default',
    id: '11',
  });
  React.useEffect(() => {
  ...
  const subCont1 = new FormItemTreeNode('Container', {
    type: 'conatiner-default',
    id: '12',
  });
  const q6 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '6',
    label: '6.What is your name?',
  });
  const q1 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '1',
    label: '1.What is your name?',
  });
  const q2 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '2',
    label: '2.What is your name?',
  });
  const q3 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '3',
    label: '3.What is your name?',
  });
  const q4 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '4',
    label: '4.What is your name?',
  });
  const q5 = new FormItemTreeNode('Question', {
    type: 'text',
    id: '5',
    label: '5.What is your name?',
  });
  ...
  const addQuestion = (conatiner: FormItemTreeNode) => {
    const temp = new FormItemTreeNode('Question', {
      type: 'text',
      id: '5',
      label: '5.Whatxxx is your name?',
    });
  ...
  const containerRender = (
    structure: FormItemTreeNode | FormItemTreeNode[]
  ) => {
    return structure && Array.isArray(structure) ? (
      structure.map((item) => {
          ...
          return (
            <div className="df-generator-form-container">
              <div className="df-generator-form-add-container">
                <div
                  className="df-generator-form-add"
